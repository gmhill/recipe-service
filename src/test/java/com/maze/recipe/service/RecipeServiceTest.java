...
class RecipeServiceTest {
    ...
    void updateRecipeThrowsNotFoundForUnseededId() {
        ...
        // When/Then
        assertThatThrownBy(() -> service.updateRecipe(Long.MAX_VALUE, updateDto)).isInstanceOf(RecipeNotFoundException.class);
    }
    ...
    void updateRecipeThrowsInvalidIdForNonPositiveId() {
        ...
        // When/Then
        assertThatThrownBy(() -> service.updateRecipe(-1L, updateDto)).isInstanceOf(InvalidIdException.class);
    }
