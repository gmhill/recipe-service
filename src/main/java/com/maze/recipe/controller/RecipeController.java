...
public class RecipeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RecipeResponseDto> updateRecipe(@PathVariable long id, @RequestBody CreateRecipeDto createRecipeDto) {
        return ResponseEntity.ok(recipeService.updateRecipe(id, createRecipeDto));
    }
