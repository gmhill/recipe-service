...
public class RecipeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RecipeResponseDto> updateRecipe(@PathVariable long id, @RequestBody CreateRecipeDto updateRecipeDto) {
        return ResponseEntity.ok(recipeService.updateRecipe(id, updateRecipeDto));
    }
